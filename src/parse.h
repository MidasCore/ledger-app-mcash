...
#define M20_DATA_FIELD_SIZE 68

#define SUN_DIG 8
#define ADD_PRE_FIX_BYTE_MAINNET 0x32
...
#define CHAIN_CODE "MCASH\0"
#define CHAIN_CODE_LENGTH 5
#define CHAIN_DECIMALS 8
